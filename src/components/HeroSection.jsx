  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="https://images.unsplash.com/photo-1488646953014-85cb937266d7?w=1600&q=80"
          alt="Hero Background"
      ...
      >
        ...
        <motion.h1
          variants={itemVariants}
          className="font-poppins font-bold text-5xl sm:text-6xl md:text-7xl leading-tight mb-xl"
        >
          Pengalaman Wisata <br />
          <span className="text-secondary">Tak Terlupakan</span>
        </motion.h1>
        ...
        >
          <Link
            to="/packages"
            className="inline-flex items-center gap-md px-2xl py-lg font-inter font-bold text-base text-primary bg-white rounded-lg hover:bg-gray-100 transition-all duration-300 hover:shadow-medium"
          >
            Lihat Paket Wisata
            <HiArrowRight />
          </Link>
          ...
          <a
            ...
            className="inline-flex items-center gap-md px-2xl py-lg font-inter font-bold text-base text-white border-2 border-white rounded-lg hover:bg-white/10 transition-all duration-300"
          >
            Konsultasi Gratis
            <HiArrowRight />
          </a>
