    ...
    <div className="min-h-screen bg-white">
          ...
          >
            {packageCategories.map((category) => (
              <button
                ...
                className={`px-xl py-md font-inter font-semibold rounded-lg transition-all duration-300 ${
      ...
      >
        <div className="max-w-3xl mx-auto text-center px-lg">
          ...
          <a
            href="https://wa.me/628123456789?text=Saya%20ingin%20konsultasi%20paket%20custom"
            target="_blank"
